...
<html lang="en">
  ...
  <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size="default" data-sidebar-user="false">
    ...
    <div id="wrapper">
      <!-- Topbar Start -->
      <div class="navbar-custom bg-theme">
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
              <a class="nav-link dropdown-toggle waves-effect waves-light" href="{{route('home')}}" target="_blank"> <i data-feather="globe"></i> হোম পেইজ </a>
            </li>
          </ul>
              ...
              <li>
                ...
                <div class="collapse" id="sitebar-report">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('customers.ip_block')}}"><i data-feather="file-plus"></i> Customer IP Block</a>
                    </li>
                    <li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end">&copy; {{$generalsetting->name}} <a href="https://wa.me/8801970366446" target="_blank">CoderS</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
