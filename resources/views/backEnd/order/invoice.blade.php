                    ...
                    <table style="width:100%">
                        <tr>
                            ...
                            <td  style="width:60%;float: left;">
                                <div class="invoice-bar" style=" background: #3BB77E; transform: skew(38deg); width: 100%; margin-left: 65px; padding: 20px 60px; ">
                    ...
                    <table class="table" style="margin-top: 30px;margin-bottom: 0;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$value->product_name}} <br> @if($value->product_size || $value->product_color) <h4 style="color:rgb(211, 4, 4);">Size: {{$value->product_size}} &nbsp; &nbsp; Color: {{$value->product_color}} @endif </h4></td>
                    ...
                    <div class="invoice-bottom">
                        ...
                        <table class="table" style="width: 300px; float: right;    margin-bottom: 30px;">
                            <tbody style="background:#f1f9f8">
                                ...
                                <tr style="background:#3BB77E;color:#fff">
