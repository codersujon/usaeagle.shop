    ...
    <body class="gotop">
        ...
        <header id="navbar_top">
            ...
            <div class="announcement__bar">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-2">
                            <div class="track_btn text-center">
                                <a href="{{route('customer.order_track')}}" class="text-white"><strong><i class="fas fa-truck-moving"></i> অর্ডার ট্রাকিং </strong></a>
                            </div>
                        </div>
                        <div class="col-8">
                            <div class="announcement py-2">
                                <p class="text-center text-white">আমাদের যে কোন পণ্য অর্ডার করতে কল বা WhatsApp করুন:  +8801748381538 এই নাম্বারে</p>
                            </div>
                        </div>
                        <div class="col-2">
                            ...
                            @else
                            <div class="for_order text-center">
                                    <a href="{{route('customer.login')}}" class="text-white"><strong><i class="fas fa-sign-in-alt"></i> লগইন</strong></a>
                            </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="mobile-search">
                <form action="{{route('search')}}">
                    <input type="text" placeholder="এখানে প্রোডাক্ট খুজুন..." value="" class="msearch_keyword msearch_click" name="keyword" />
                    ...
                    <div class="logo-area">
                        <div class="container">
                            <div class="row d-flex align-items-center">
                                <div class="col-sm-2">
                                    <div class="main-logo">
                                        <a href="{{route('home')}}"><img src="{{asset($generalsetting->white_logo)}}" alt="Fashion In Dhaka" /></a>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                        <div class="main-search">
                                            <form action="{{route('search')}}">
                                                <input type="text" placeholder="এখানে প্রোডাক্ট খুজুন..." class="search_keyword search_click" name="keyword" />
                                                <button>
        ...
        <footer>
            <div class="footer-top">
                <div class="container">
                    <div class="row ">
                        <div class="col-sm-6 mb-3 mb-sm-0 offset-md-3">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright">
                                <p>~স্বত্ব © {{ date('Y') }} {{$generalsetting->name}} কর্তৃক সর্বস্বত্ব সংরক্ষিত~</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="footer_nav">
            <ul>
                ...
                <li>
                    <a href="https://wa.me/01845862150">
                        <span>
