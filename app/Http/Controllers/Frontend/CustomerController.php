...
class CustomerController extends Controller
{
    ...
    public function order_save(Request $request){
        $this->validate($request,[
            ...
            'name.required' => 'অনুগ্রহ করে খালিঘরে আপনার নাম লিখুন!',
            'phone.required' => 'অনুগ্রহ করে খালিঘরে ১১ ডিজিটের মোবাইল লিখুন!',
            'address.required' => 'অনুগ্রহ করে কোন জায়গা থেকে পার্সেল রিসিভ করবেন নির্দিষ্ট করে সম্পূর্ণ পিক-আপ পয়েন্টের ঠিকানা লিখুন!',
        ]);
       ...
       // order details data save
        ...
        foreach (Cart::instance('shopping')->content() as $cart) {
            ...
            $order_details->product_color = isset($request->product_color) ? $request->product_color : $cart->options->product_color;
            $order_details->product_size = isset($request->product_size) ? $request->product_size : $cart->options->product_size;
